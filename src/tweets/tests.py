...
class TweetTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='dhaval', password='password')
        self.userb = User.objects.create_user(username='dhaval-2', password='password2')
    ...
    def test_tweet_create_api_view(self):
        request_data = {"content": "This is my first test tweet"}
        client = self.get_client() 
